...
export default function HardDaysFilmPage() {
  return (
      ...
      <div className="w-full bg-black">
        <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 py-12">
          <div className="relative overflow-hidden rounded-lg shadow-2xl max-w-2xl mx-auto">
            <Image
              src="/images/Films/Hard_Days.webp"
              alt="Hard Days - Film Poster"
              width={800}
              height={1200}
        ...
        <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 py-16">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <h1 className="text-4xl font-bold mb-4 text-champagne">Hard Days</h1>
              ...
              <div className="mb-8">
                ...
                <p className="text-lg text-champagne/85 leading-relaxed">
                  ...
                  The film's story tells about the Corona pandemic and its impact on human relationships with persons living on the street and how these animals lived their lives in those days. The workshop was implemented with the support of 
                  the Al-Noon Foundation for Family Care and the Gang Academy for KKnowledge Training and Consultation.
