...
export default function HelpUsOurLadyFilmPage() {
  return (
      ...
      <div className="w-full bg-black">
        <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 py-12">
          <div className="relative overflow-hidden rounded-lg shadow-2xl max-w-2xl mx-auto">
            <Image
              src="/images/Films/Help_Us_Our_Lady.webp"
              alt="Help Us, Our Lady - Film Poster"
              width={800}
              height={1200}
        ...
        <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 py-16">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <h1 className="text-4xl font-bold mb-4 text-champagne">Help Us, Our Lady</h1>
              ...
              <div className="mb-8">
                ...
                <p className="text-lg text-champagne/85 leading-relaxed">
                  Zainab's family is an anthropological/ethnographic study of an Egyptian family in 100 years, but the history is from the women's point of view, and the film is the first story in the book,
                  which tells about my grandmother's mother dreaming of the good news that she is pregnant with my grandmother, Zainab. The film is an entry portal into the world of Zainab's family.
                </p>
              </div>
            </div>
          </div>
