...
export default function TheKingdomOfTheMonoCellFilmPage() {
  return (
        ...
        <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 py-16">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <h1 className="text-4xl font-bold mb-4 text-champagne">The Kingdom of the Mono Cell</h1>
              ...
              <div className="bg-gray-900 border-l-4 border-[#C9A84F] p-6 rounded-lg mb-8">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-lg text-champagne/90">Marwa Abd El Moneim</p>
                  </div>
                  <div>
              ...
              <div className="mb-8">
                ...
                <p className="text-lg text-champagne/85 leading-relaxed">
                  The kingdom of a cell is a film that speaks primarily of the concept of life in which we live as living beings.
                  The organisms that grow and multiply and move from one place to another have properties and recipes of their own, and non-living organisms that do not grow and do not multiply and do not move.
                  By focusing on the characteristics of life, growth, responsiveness, nutrition, movement, breathing, concentration, and output.
